...
const VirginiaRules: React.FC = () => {
    ...
    return (
        <div className="w-full max-w-4xl flex flex-col items-center">
            <h2 className="text-3xl font-bold mb-2 text-gray-200">Ask PitProRite: Virginia Live Casino Rules</h2>
            ...
            <div className="w-full bg-gray-900/50 p-6 rounded-lg border border-gray-700">
                <form onSubmit={handleSubmit}>
                    ...
                    >
                        {isLoading ? 'PitProRite is Thinking...' : 'Ask PitProRite'}
                    </button>
                </form>
            </div>
            ...
            <div className="w-full mt-6">
                ...
                {answer && (
                    <div className="bg-gray-700/50 p-6 rounded-lg border border-gray-600 animate-fade-in">
                        <h3 className="text-2xl font-bold text-gray-300 mb-3">PitProRite's Answer:</h3>
