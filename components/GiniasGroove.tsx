    ...
    if (sessionState === 'idle') {
        ...
        return (
            <div className="text-center">
                <h2 className="text-4xl font-bold mb-2 text-slate-200">Select Your Challenge</h2>
    ...
    if (sessionState === 'finished') {
        return (
            <div className="text-center bg-slate-800 p-8 rounded-lg shadow-2xl">
                ...
                <p className="text-2xl text-slate-300 mb-2">You completed the {difficulty} challenge!</p>
