...
const CATEGORY_LABELS: { [key in ScenarioType]: string } = {
...
const mathScenarios = [
    ...
    {
        q: "A player doubles down on a $20 bet, and the hand pushes against the dealer. What happens to the player's total bet?",
        options: ["The player loses the doubled part ($20).", "The player loses the full bet ($40).", "The full bet of $40 is returned to the player.", "The original bet ($20) is returned."],
        a: "The full bet of $40 is returned to the player.",
        explanation: "In a push, the player neither wins nor loses. The entire wager for that hand, including any money from doubling or splitting, is returned."
    },
    {
        q: "A player bets $100, gets a Blackjack. The dealer shows an Ace. The player takes insurance for $50. The dealer also has a Blackjack. What is the player's net win/loss?",
        options: ["Push (no win/loss)", "Win $50", "Win $100", "Lose $50"],
        a: "Win $50",
        explanation: "The main $100 Blackjack bet pushes against the dealer's Blackjack. The $50 insurance bet wins and pays 2:1 ($100). The player's net profit is $50."
    },
    {
        q: "A player bets $30 and doubles down. The hand loses. How much money does the player lose in total?",
        options: ["$30", "$45", "$60", "$90"],
        a: "$60",
        explanation: "Doubling down doubles the player's wager. The total amount at risk is $60 ($30 original + $30 double), which is lost."
    },
    {
        q: "A player bets $10 on two hands. Hand 1 gets a 3:2 Blackjack. Hand 2 pushes with the dealer. What is the player's total net win?",
        options: ["$10", "$15", "$25", "Push"],
        a: "$15",
        explanation: "Hand 1 wins $15 ($10 x 1.5). Hand 2 is a push, so the $10 bet is returned. The total profit for the round is $15."
    },
    {
        q: "What is the payout for a winning $12 bet on a 6:5 Blackjack table?",
        options: ["$12", "$14.40", "$15", "$18"],
        a: "$14.40",
        explanation: "The payout is 1.2 times the bet. $12 x 1.2 = $14.40."
    },
    {
        q: "A player bets $50. They also place a $5 tip bet for the dealer. The hand loses. What is the player's total loss?",
        options: ["$50", "$52.50", "$55", "$45"],
        a: "$55",
        explanation: "The player loses their main $50 bet and the separate $5 tip bet, for a total loss of $55."
    },
    {
        q: "A player bets $10, doubles down to $20. They get 21. The dealer also gets 21. What's the outcome?",
        options: ["Player wins $20", "Player wins $10", "Push", "Player loses $20"],
        a: "Push",
        explanation: "When the player and dealer have the same total, it's a push. The player's entire $20 wager is returned."
    },
    {
        q: "What is the standard payout for a '5-Card Charlie' (a 5-card hand that hasn't busted)?",
        options: ["It pays 3:2 automatically.", "It pays 2:1 automatically.", "It is an automatic win, paying 1:1.", "It is not a winning hand unless its total beats the dealer."],
        a: "It is not a winning hand unless its total beats the dealer.",
        explanation: "While some casinos have special rules, a 5-Card Charlie is not a standard feature of Blackjack. It's simply a hand with a point total, which wins or loses normally."
    },
    {
        q: "A player bets $40, splits Aces. The first hand gets a Jack (21). The second hand gets a 2 (13). The dealer busts. What is the player's net win?",
        options: ["$80", "$40", "$120", "$60"],
        a: "$80",
        explanation: "Both hands win. A 21 made after splitting is not a Blackjack and pays 1:1. Each $40 bet wins $40, for a total win of $80."
    },
    {
        q: "A player makes a $7 bet and gets a Blackjack on a 3:2 table. How much should you pay them?",
        options: ["$10.50", "$10", "$11", "$14"],
        a: "$10.50",
        explanation: "The payout is 1.5 times the bet. $7 x 1.5 = $10.50."
    }
];
...
const rulesScenarios = [
    ...
    {
        q: "In what direction does a dealer pay winners and collect from losers?",
        options: ["From left to right.", "From right to left.", "In any order.", "The closest player first."],
        a: "From right to left.",
        explanation: "A dealer works from their right to their left (third base to first base) to maintain a consistent and secure procedure."
    },
    {
        q: "When must a dealer 'clap out' or 'clear' their hands?",
        options: ["After every hand.", "Only when a player wins a large amount.", "Before taking a break or leaving the table.", "Before shuffling the cards."],
        a: "Before taking a break or leaving the table.",
        explanation: "Clapping out shows surveillance that your hands are empty, which is a required security procedure before leaving the game."
    },
    {
        q: "Is re-splitting Aces generally allowed in casinos?",
        options: ["Yes, up to four hands.", "Yes, but only once.", "No, Aces can only be split one time.", "It depends on the dealer's up-card."],
        a: "No, Aces can only be split one time.",
        explanation: "Because splitting Aces is so advantageous to the player, it is almost universally restricted to a single split with one card drawn to each."
    },
    {
        q: "A player's bet is partially outside the betting circle. What should you do before the deal?",
        options: ["Consider it a valid bet.", "Politely ask them to place the bet fully inside the circle.", "Push the bet fully into the circle for them.", "Ignore it and deal the hand."],
        a: "Politely ask them to place the bet fully inside the circle.",
        explanation: "Bets must be clearly inside the designated area to be valid. Politely asking the player to fix it prevents disputes about the bet amount later."
    },
    {
        q: "If a dealer mistakenly hits a hard 17, what is the most likely procedure?",
        options: ["The hand stands as played.", "The extra card is burned and the hand reverts to 17.", "All player bets are returned.", "The floor supervisor must be called to make a ruling."],
        a: "The floor supervisor must be called to make a ruling.",
        explanation: "This is a significant dealer error. The supervisor will make a decision based on house procedure, which often involves the card standing or being burned."
    },
    {
        q: "If a player is 'betting behind' another player, who controls the hand's decisions?",
        options: ["The back-line bettor.", "The player with the front bet.", "They must agree on each decision.", "The dealer makes the decisions for them."],
        a: "The player with the front bet.",
        explanation: "The person with the primary bet in the circle controls all decisions. The back-line bettor is just along for the ride."
    },
    {
        q: "Can a player split a hand of a King and a Jack?",
        options: ["No, they must be the same rank (e.g., two Kings).", "Yes, as they are both 10-value cards.", "Only if they are the same suit.", "Only with supervisor approval."],
        a: "Yes, as they are both 10-value cards.",
        explanation: "Most casinos allow splitting any two cards with a value of 10, not just identical pairs."
    },
    {
        q: "You deal yourself a Blackjack by mistake (giving the dealer the second card). What is the procedure?",
        options: ["It counts as a dealer Blackjack and all players lose.", "The hand is void and all bets are pushed.", "You must call a floor supervisor for a ruling.", "You burn the card and deal a new one."],
        a: "You must call a floor supervisor for a ruling.",
        explanation: "A misdeal is a game irregularity. A supervisor must be called to determine if the hand is void or if it can be corrected."
    },
    {
        q: "When a new dealer arrives to 'tap you out' (take your place), what should they do first?",
        options: ["Start dealing the next hand immediately.", "Shuffle the cards.", "Verify the amount of chips in the chip tray.", "Ask the players if they need change."],
        a: "Verify the amount of chips in the chip tray.",
        explanation: "The incoming dealer must confirm the chip tray's balance against the table's records before taking responsibility for the game."
    },
    {
        q: "A player you don't recognize tries to 'color up' $5,000 in chips. What is a likely required step?",
        options: ["Politely refuse the transaction.", "Call a supervisor and potentially check the player's ID for gaming regulations.", "Complete the color up but report it after your shift.", "Give them cash instead of larger chips."],
        a: "Call a supervisor and potentially check the player's ID for gaming regulations.",
        explanation: "Large transactions often require supervisor oversight and may trigger currency transaction reporting requirements for which player identification is necessary."
    }
];
...
const AuditionPractice: React.FC = () => {
    ...
    const generateProblem = useCallback((selectedDifficulty: 'easy' | 'medium' | 'hard') => {
        setIsLoading(true);
        setFeedback(null);
        setUserTranscript('');
        setTextInputAnswer('');
    ...
    const handleMultipleChoiceAnswer = (selectedAnswer: string) => {
        ...
        setQuestionCounts(prev => ({...prev, [currentScenario.type]: prev[currentScenario.type] + 1 }));
        const isCorrect = selectedAnswer === currentScenario.correctAnswer;
        const explanation = currentScenario.context.explanation;
        const explanationLabel = currentScenario.type === 'math' ? 'Calculation' : 'Reason';

        if (isCorrect) {
            setScore(prev => prev + 1);
            let feedbackMessage = `Correct!`;
            if (explanation) {
                feedbackMessage += `<br/><br/><strong>${explanationLabel}:</strong> ${explanation}`;
            }
    ...
    }, [auditionState, isLoading, feedback, currentScenario, isListening]);
    ...
    const startAudition = (selectedDifficulty: 'easy' | 'medium' | 'hard') => {
        ...
        setScore(0);
        setQuestionCounts({ strategy: 0, math: 0, rules: 0, talk: 0, situational: 0 });
        const config = AUDITION_DIFFICULTY_CONFIG[selectedDifficulty];
    ...
    useEffect(() => {
        if (auditionState === 'running' && sessionTimeLeft > 0) {
            ...
            sessionTimerRef.current = timerId;
    ...
    return (
        <div className="w-full max-w-4xl flex flex-col items-center">
            ...
            {auditionState === 'running' && difficulty && (
                <div className="w-full mb-4 p-4 bg-slate-900/50 rounded-lg shadow-lg border border-slate-700 flex justify-around items-center text-center flex-wrap gap-x-6 gap-y-2">
                    <p className="font-bold text-slate-300 text-sm uppercase tracking-wider w-full mb-2 border-b border-slate-600 pb-2">Category Count</p>
                    {AUDITION_DIFFICULTY_CONFIG[difficulty].problemTypes.map(type => (
                        <div key={type}>
                            <div className="text-sm font-medium text-slate-400">{CATEGORY_LABELS[type]}</div>
                            <div className="text-2xl font-bold text-slate-200">{questionCounts[type]}</div>
                        </div>
                    ))}
                </div>
            )}
                    ...
                    {!isLoading && currentScenario && !feedback && (
                        <div className="animate-fade-in w-full">
                            <p className="text-lg font-bold text-amber-400 uppercase tracking-wider mb-4">
                                {CATEGORY_LABELS[currentScenario.type]}
                            </p>
                            ...
                            {currentScenario.type === 'strategy' && (
                                <div className="text-xl text-slate-400 mb-6">
                                    {/* FIX: Pass the dealer's up card to getHandValue. */}
                ...
                <div className="w-full p-4 bg-slate-900/50 rounded-lg mt-6 flex items-center justify-center gap-4 border-t-2 border-slate-700 min-h-[82px]">
                    {feedback ? (
                        <button
                            ...
                            className="bg-sky-600 hover:bg-sky-500 text-white font-bold py-3 px-6 rounded-lg text-lg transition-transform transform hover:scale-105"
                        >
                            Next Question
                        </button>
                    ) : (
                        !isMultipleChoice && currentScenario && (
                                ...
                                { recognitionRef.current ? (
                                    <>
                                        <div className="flex items-center gap-3">
                                            ...
                                            {isListening ? (
                                                <p className="text-lg text-slate-300 italic">Listening...</p>
                                            ) : (
                                                <p className="text-lg text-slate-400">Speak your answer clearly.</p>
                                            )}
                                        </div>
                                        {micStatusMessage && <p className="text-sm text-amber-400">{micStatusMessage}</p>}
                                        {userTranscript && <p className="text-sm text-slate-500 mt-1">Heard: "{userTranscript}"</p>}
                                    </>
                                ) : (
                                    <p className="text-red-400">Speech input not available.</p>
                                )}
                                
                                <form onSubmit={handleTextSubmit} className="flex items-center gap-2 mt-2">
                                    <input 
                                        type="text"
                                        value={textInputAnswer}
                                        onChange={(e) => setTextInputAnswer(e.target.value)}
                                        placeholder="Or type answer here..."
                                        className="bg-slate-800 border-2 border-slate-600 rounded-lg text-white px-3 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-sky-400"
                                    />
                                    <button type="submit" className="bg-slate-600 hover:bg-slate-500 text-white font-semibold py-1 px-3 rounded-lg text-sm">Submit</button>
                                </form>
                            </div>
                        )
                    )}
